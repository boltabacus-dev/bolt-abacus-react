...
import UnTimedPracticeSection from '@components/sections/student/practice/UnTimedSection';
...
export interface StudentUnTimedPracticePageProps {}

const StudentUnTimedPracticePage: FC<StudentUnTimedPracticePageProps> = () => {
        ...
        <div>
          {apiError ? (
            ...
            <>
              ...
              <UnTimedPracticeSection operation={params.operation!} />
            </>
          )}
        </div>
      )}
...
export default StudentUnTimedPracticePage;
