...
import TimedPracticeSection from '@components/sections/student/practice/TimedSection';
...
export interface StudentTimedPracticePageProps {}

const StudentTimedPracticePage: FC<StudentTimedPracticePageProps> = () => {
        ...
        <div>
          {apiError ? (
            ...
            <>
              ...
              <TimedPracticeSection operation={params.operation!} />
            </>
          )}
        </div>
      )}
...
export default StudentTimedPracticePage;
