...
import SubAdminStudentProgressSection from '@components/sections/sub-admin/StudentProgressSection';

export interface SubAdminStudentProgressPageProps {}

const SubAdminStudentProgressPage: FC<
  SubAdminStudentProgressPageProps
> = () => {
        ...
        <div>
          {apiError ? (
            ...
            <>
              ...
              <SubAdminStudentProgressSection
...
export default SubAdminStudentProgressPage;
