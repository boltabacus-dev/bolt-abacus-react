...
import AddStudentSection from '@components/sections/sub-admin/AddStudentSection';
...
const SubAdminAddStudentPage: FC<SubAdminAddStudentPageProps> = () => {
...
export default SubAdminAddStudentPage;
