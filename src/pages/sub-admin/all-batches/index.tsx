...
import ViewAllBatchesSection from '@components/sections/sub-admin/ViewAllBatchesSection';
...
export interface SubAdminViewAllBatchesPageProps {}

const SubAdminViewAllBatchesPage: FC<SubAdminViewAllBatchesPageProps> = () => {
...
export default SubAdminViewAllBatchesPage;
