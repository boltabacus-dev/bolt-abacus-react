...
import BulkAddStudentSection from '@components/sections/sub-admin/BulkAddStudentSection';
...
export interface SubAdminBulkAddStudentPageProps {}

const SubAdminBulkAddStudentPage: FC<SubAdminBulkAddStudentPageProps> = () => {
...
export default SubAdminBulkAddStudentPage;
