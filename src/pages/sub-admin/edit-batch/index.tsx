...
import EditBatchSection from '@components/sections/sub-admin/EditBatchSection';
...
export interface SubAdminEditBatchPageProps {}

const SubAdminEditBatchPage: FC<SubAdminEditBatchPageProps> = () => {
...
export default SubAdminEditBatchPage;
