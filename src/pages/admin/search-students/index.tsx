...
import SearchStudentSection from '@components/sections/admin/SearchStudentSection';

export interface AdminSearchStudentsPageProps {}

const AdminSearchStudentsPage: FC<AdminSearchStudentsPageProps> = () => {
...
export default AdminSearchStudentsPage;
