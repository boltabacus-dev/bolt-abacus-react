...
import {
  ...
  SUB_ADMIN_ALL_TEACHER,
  SUB_ADMIN_SEARCH_STUDENT,
  ...
  return (
    <div className="hidden py-12 pl-4 tablet:flex">
      <div className="flex flex-col flex-1 gap-3 p-4 text-lg rounded-lg bg-grey">
        ...
        <Link to={SUB_ADMIN_SEARCH_STUDENT}>
          <AdminLinkButton
            text="Search Student"
            active={location.pathname === SUB_ADMIN_SEARCH_STUDENT}
          />
        </Link>
        <Link to={SUB_ADMIN_ALL_TEACHER}>
          <AdminLinkButton
            text="All Teacher"
            active={location.pathname === SUB_ADMIN_ALL_TEACHER}
          />
        </Link>
