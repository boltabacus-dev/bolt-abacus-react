...
const ViewAllTeachersSection: FC<ViewAllTeachersSectionProps> = ({
  ...
  const firstNameCmp = memo<{ column: Column<Teacher, unknown> }>(
    ({ column }) => {
      return (
        <button
          type="button"
  ...
  const lastNameCmp = memo<{ column: Column<Teacher, unknown> }>(
    ({ column }) => {
      return (
        <button
          type="button"
  ...
  const actionButtons = memo<{ row: Row<Teacher> }>(({ row }) => (
    <button
      type="button"
  ...
  const customGlobalFilterFn: FilterFn<Teacher> = (
    row,
    _columnId,
    filterValue
  ) => {
