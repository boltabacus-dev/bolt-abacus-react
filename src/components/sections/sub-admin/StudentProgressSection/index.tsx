...
export interface SubAdminStudentProgressSectionProps {
  studentName: string;
  batchName: string;
  progress: LevelProgress[];
}

const SubAdminStudentProgressSection: FC<
  SubAdminStudentProgressSectionProps
> = ({ studentName, batchName, progress }) => {
  return (
    <div
...
export default SubAdminStudentProgressSection;
